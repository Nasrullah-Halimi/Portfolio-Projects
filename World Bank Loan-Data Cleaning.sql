...
--Change datetime to date - When no date set it to Null.
UPDATE IBRD SET 
...
--Populate Guarantor data where it is null. 
...
--Spliting Original Principal Amount into columns (Original Amount, Currency of Commitment)
SELECT
...
--Capitalize first letter of each word in Project Name, Borrower and Region Columns
